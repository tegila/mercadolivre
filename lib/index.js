...
(function() {
  var Auth, Item, Mercadolivre, Orders, Questions, Rest, Rest_browser, Rest_node, Search, Shipping, Users, Utils, _, config, https, log, querystring;
  ...
  Orders.get_order = function(order_id, callback) {
    return Auth.get_token(function() {
      return Rest._get("/orders/" + order_id, config.session, callback);
    });
  };
  ...
  Mercadolivre.server_side = function(client_id, client_secret, session) {
