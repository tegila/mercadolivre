...
(function() {
  ...
  Auth.set_apikey = function(client_id, client_secret) {
  ...
  Item.get_item = function(item_id, callback) {
    return Auth.get_token(function() {
      return Rest._get("/items/" + item_id, _.pick(config.session, ['access_token', 'seller_id']), callback);
    });
  };
  ...
  Item.with_description = function(item_id, callback) {
    return Rest._get("/items/" + item_id, {}, function(err, product) {
      return Rest._get("/items/" + item_id + "/description", {}, function(err, description) {
        return callback(err, _.extend({}, product, description));
      });
    });
  };
